...
for methodologies such as agile software development. These principles work hand-in-hand with [design patterns](/my-learning-curve/blog/17-design-patterns) to create robust, maintainable code.
