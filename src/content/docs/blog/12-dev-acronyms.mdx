...
**The Reality:** Spending 3 weeks arguing about what a "User" actually _is_
...
account _and_ arrives in the other one, rather than vanishing into the void.

<Aside type="note">
  See the [ACID](/my-learning-curve/blog/13-acid) post for a deeper dive
</Aside>
