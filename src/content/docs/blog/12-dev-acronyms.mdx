...
<Aside type="note">
See the [dedicated post on SOLID](./11-solid-principles)
</Aside>
...
<Aside type="note">
See the basic [CRUD examples](../../snippets/sql/crud)
</Aside>
...
- [Refactoring.guru](https://refactoring.guru/design-patterns) - Excellent for visualizing patterns and SOLID.
