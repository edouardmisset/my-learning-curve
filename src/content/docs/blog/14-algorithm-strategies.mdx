...
tags:
  ['Algorithms', 'TypeScript', 'Strategies', 'Optimization', 'Problem Solving']
...
> An algorithm is a finite sequence of instructions, typically used to solve a
...
O(n) or even O(log n) solution. 🚀

Here are _7_ strategies that every developer should have in their toolkit.
...
possibly be completed to a valid solution. One way to think about it is like
...
- [Introduction to
  Algorithms](https://mitpress.ublish.com/ebook/introduction-to-algorithms-4-preview/12675/5)
  by Cormen, Leiserson, Rivest, and Stein
- [GeeksForGeeks](https://www.geeksforgeeks.org/dsa/algorithms-design-techniques/)
  on Algorithm Design
- Algorithms and Data Structures in TypeScript by [Oleksii
  Trekhleb](https://github.com/trekhleb/javascript-algorithms)
- [GeeksForGeeks](https://www.geeksforgeeks.org/dsa/greedy-algorithms/) on Greedy Algorithms
- [GeeksForGeeks](https://www.geeksforgeeks.org/dsa/backtracking-algorithms/) on Backtracking Algorithms
- [GeeksForGeeks](https://www.geeksforgeeks.org/competitive-programming/dynamic-programming/) on Dynamic Programming
