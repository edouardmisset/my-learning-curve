...
Design patterns are typical solutions to common problems in software design. To learn more about how to apply design patterns in TypeScript with practical examples, see [Design Patterns in TypeScript](/my-learning-curve/blog/17-design-patterns).
