...
const chip = new Microchip('981020001234567');
// chip.id = '000000000000000'; // Error: Cannot assign to 'id' because it is a read-only property.
```
...
See the [Generics](./02-generics) article for more details.
...
- **[SOLID Principles](./11-solid-principles)**: A set of five design principles intended to make software designs more understandable, flexible, and maintainable.
- **[DRY (Don't Repeat Yourself)](./10-dry-principle)**: Reduces repetition of software patterns, replacing it with abstractions or using data normalization.
