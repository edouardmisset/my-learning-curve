...
- **Object-Oriented (OOP):** Encapsulates data and methods into objects.
...
- **Functional (FP):** Builds programs by applying and composing functions.
...
- **Database/Query:** Asks for data matching criteria (e.g., [SQL](https://en.wikipedia.org/wiki/SQL)).
...
- **Critics:** Often criticized for encouraging mutable state (which leads to bugs) and for creating rigid class structures that are hard to refactor.
