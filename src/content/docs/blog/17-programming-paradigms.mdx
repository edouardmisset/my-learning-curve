...
- **Critics:** Often criticized for encouraging mutable state (which leads to bugs) and for creating rigid class structures that are hard to refactor. Adhering to [SOLID principles](/my-learning-curve/blog/11-solid-principles) and using appropriate [design patterns](/my-learning-curve/blog/17-design-patterns) is often cited.
