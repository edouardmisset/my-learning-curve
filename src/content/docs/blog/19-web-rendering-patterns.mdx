...
Instead of the server waiting for the _entire_ page to be ready before sending it, it streams HTML in chunks. You might get the "Header" instantly while the "Product List" database query is still running.
...
<Aside type="tip">
  This is a philosophy, not just a tech stack. It ensures your app works on a 3G
  connection.
</Aside>
