...
This rule is a direct expression of the [**KISS** principle](https://en.wikipedia.org/wiki/KISS_principle) (_Keep It Simple, Stupid_), and Ken Thompson rephrased Rules 3 and 4 together as: _"When in doubt, use brute force."_
