...
- **Code Spell Checker French** (`streetsidesoftware.code-spell-checker-french`) - French language support for Code Spell Checker
...
- **ES7+ React/Redux/React-Native snippets** (`dsznajder.es7-react-js-snippets`) - Extensions for React, React-Native and Redux in JS/TS with ES7+ syntax
